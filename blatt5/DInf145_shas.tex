...
\begin{tikzpicture}[->, auto, node distance=3cm]
  ...
  \path (Z1) edge [loop below] node {$\cdot \in \Sigma,\cdot / \epsilon$}  (Z1)
             edge [loop above,align=center] node {$\epsilon,S/ab$ \\ $\epsilon,S/ba$ \\ $\epsilon,S/bSa$ \\ 
                                                  $\epsilon,S/aSb$ \\$\epsilon,S/SS$} (Z1);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[->, auto, node distance=3cm]
  \node[initial,state] (Z1) {$Z_1$};
  \path (Z1) edge [loop below] node {$\cdot \in \Sigma,\cdot / \epsilon$}  (Z1)
             edge [loop above,align=center] node {$\epsilon,S/\eighthnote\halfnote\halfnote$ \\ 
                                                  $\epsilon,S/\eighthnote S\halfnote\halfnote$} (Z1);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[->, auto, node distance=3cm]
  \node[initial,state] (Z1) {$Z_1$};
  \path (Z1) edge [loop below] node {$\cdot \in \Sigma,\cdot / \epsilon$}  (Z1)
             edge [loop above,align=center] node {$\epsilon,S/CD$ \\ $\epsilon,S/AB$ \\ $\epsilon,C/c$ \\ $\epsilon,C/cC$ \\
                                                  $\epsilon,D/aDb$ \\ $\epsilon,D/ab$ \\ $\epsilon,A/aA$ \\ $\epsilon,A/a$ \\
                                                  $\epsilon,B/bB$ \\ $\epsilon,B/b$} (Z1);
\end{tikzpicture}
\end{center}
