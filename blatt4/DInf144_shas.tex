...
|v| = l &\geq 1 \\
|uv| &\leq n \\
u &= \eighthnote^{n-l}, v = \eighthnote^l, w = \halfnote^{2n} \\
uv^0w &= \eighthnote^{n-l}\halfnote^{2n} \notin L_1
\end{align}
...
|v| &\geq 1\\
|uv| &\leq n\\
u &= \eighthnote^{n-1}, v = \eighthnote, w = \halfnote^j \\
uv^{x+1}w &= \eighthnote^{n+x+1}\halfnote^{j} \notin L_2
\end{align}
...
v &= \quarternote^{n} \\
w &= \quarternote^{n(n-1)} \\
\Rightarrow uv^*w &= \left(\quarternote^{n}\right)^*\quarternote^{n(n-1)} \\
uv^2w &= \quarternote^{n}\quarternote^{n}\quarternote^{n(n-1)} = \quarternote^{n+n+n^2-n} \\
\Rightarrow |\quarternote^{n+n+n^2-n}| &= n^2+n < (n+1)^2 = |\quarternote^{(n+1)^2}|
\end{align*}
...
L_3 = L \backslash L_2 &= \left\{c^ja^ib^i | i,j \geq 0 \right\} \cup \left\{ a^jb^i |i,j \geq 0 \right\}\ \backslash\ \left\{ a^jb^i |i,j \geq 0 \right\}\ \\
                       &= \left\{c^ja^ib^i | i \geq 0, j \geq 1 \right\}
\end{align*}

$L_3$ ist nach Annahme, dass $L$ regulär ist, weiterhin regulär. 
...
\begin{align*}
L_5 = L_3 \backslash L_4 &= \left\{c^ja^ib^i | i \geq 0, j \geq 1 \right\} \backslash \left\{c^ia^jb^k | i \geq 1, j, k \geq 0 \right\} \\
